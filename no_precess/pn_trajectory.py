...
def residuals(timings, windows, errs, sma, e, incl, a, logMbh, theta_obs, dt):
	t, r, (x, y, z), _ = trajectory(windows, logMbh, sma, e, incl, a, np.zeros_like(a), np.zeros_like(a), np.zeros_like(a), dt)
